...
link:../../Getting_Started/managed-devices{outfilesuffix}[Managed devices] can be attached to
...
consistently to multiple link:../../Getting_Started/managed-devices{outfilesuffix}[Managed devices].
